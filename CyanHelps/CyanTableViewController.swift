...
let songSamples =   [Sample(name: "TEKKEN 7",                   genre: .namco),
                     ...
                     Sample(name: "FUCK I DONT KNOW",           genre: .namco),
                     Sample(name: "FUCKING NAMCO SONGS",        genre: .namco),
                     Sample(name: "WHATTHEFUCK2000",            genre: .namco),
                     Sample(name: "Kart rider BGM",             genre: .game),
                     Sample(name: "LoL rank game BGM",          genre: .game),
                     Sample(name: "MOTHERMansumugang",          genre: .game),
